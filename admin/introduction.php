...
<div class="spacer">
       ...
       if(isset($_GET['id'])){
           $id=$_GET['id'];
            $del="DELETE FROM `membre` WHERE `Cin`='$id' ";
            $conn->exec($del);
       }       
       ...
       <td>             </td><td> <b>Poste dans le club :</b></td><td>Effacer</td></tr>";
       while($ligne=$res->fetch()){
              echo"<tr><td>".
              $ligne['nom']." ".
              $ligne['prenom']."</td><td></td><td>".
              $ligne['post']."</td><td><a href='?id=".
              $ligne['Cin']."'>X</a></td></tr>";
       }
       echo"</table>";
       echo'</div>';
       ...
       <div class="col-sm-4"><p>  Pour plus d'information sur le <b> club Microsoft Tech </b> : <br/>      
	           Email: <a href ="microsoftclubisetkr@gmail.com">microsoftclubisetkr@gmail.com</a> </p></div>
       </div> <br/><br/><br/>
